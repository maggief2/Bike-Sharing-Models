...
```{r}
<<<<<<< HEAD
lm1.fit <- lm(cnt ~ atemp, data = Day.Train)
=======
...
```
>>>>>>> f8ec747da3392a8bf2e92d76afac604154bc88ba
...
This code allows us to automatically generate an analysis report for each weekday variables.
