...
|:--------|---------:|------:|------:|----------:|
| Min.    |  627.000 | 0.211 | 0.188 |     0.045 |
| 1st Qu. | 2737.250 | 0.325 | 0.516 |     0.153 |
| Median  | 4617.500 | 0.425 | 0.613 |     0.191 |
| Mean    | 4526.118 | 0.464 | 0.613 |     0.201 |
| 3rd Qu. | 6163.750 | 0.611 | 0.722 |     0.235 |
| Max.    | 8555.000 | 0.805 | 0.911 |     0.507 |

Summary of Quantitative variables (Saturday)
...
![](SaturdayAnalysis_files/figure-gfm/unnamed-chunk-4-2.png)<!-- -->
...
![](SaturdayAnalysis_files/figure-gfm/unnamed-chunk-4-3.png)<!-- -->
...
1272.53. The Boosted Tree Model is the **winner** for Saturday’s data!
