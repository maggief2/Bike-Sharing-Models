...
|:--------|--------:|------:|------:|----------:|
| Min.    |  623.00 | 0.151 | 0.000 |     0.053 |
| 1st Qu. | 3270.75 | 0.365 | 0.536 |     0.136 |
| Median  | 4670.50 | 0.486 | 0.602 |     0.183 |
| Mean    | 4627.25 | 0.482 | 0.608 |     0.190 |
| 3rd Qu. | 6249.25 | 0.619 | 0.698 |     0.226 |
| Max.    | 7765.00 | 0.826 | 0.940 |     0.442 |

Summary of Quantitative variables (Thursday)
...
![](ThursdayAnalysis_files/figure-gfm/unnamed-chunk-4-2.png)<!-- -->
...
![](ThursdayAnalysis_files/figure-gfm/unnamed-chunk-4-3.png)<!-- -->
...
1612.98. The Boosted Tree Model is the **winner** for Thursday’s data!
